...
#define WIFI_SSID "WIFI-ADRIANO" // "WIFI-ADRIANO" rede de casa
#define WIFI_PASSWORD "WIFI@ADRIANO" // "WIFI@ADRIANO" senha 
...
void loop() {
  ...
  float tensPlaca_mV = map(leitTensPlaca, 0, 4095, 0, 158000);
